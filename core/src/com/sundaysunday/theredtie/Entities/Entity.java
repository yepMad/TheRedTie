...
public class Entity
{
    ...
    public boolean tbCollideWith(Entity m_polygon, Player m_circle, float vely, float dt) {

        Polygon polygon = m_polygon.getPolygonHitbox();
        Circle circle = m_circle.getCircleHitbox();

        float[] vertices = polygon.getTransformedVertices();
        Vector2 center = new Vector2(m_circle.getPositionX(), (m_circle.getPositionY()+(vely * dt)));
